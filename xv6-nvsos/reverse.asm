...
_reverse:     file format elf32-i386
...
main(int argc, char *argv[])
{
  ...
  16:	00 
  17:	8d 74 24 1c          	lea    0x1c(%esp),%esi
  1b:	8d 5c 24 1b          	lea    0x1b(%esp),%ebx
  1f:	8b 40 04             	mov    0x4(%eax),%eax
  22:	89 04 24             	mov    %eax,(%esp)
  25:	e8 c8 02 00 00       	call   2f2 <open>
  2a:	89 44 24 0c          	mov    %eax,0xc(%esp)
  2e:	66 90                	xchg   %ax,%ax
      
      while((n=read(f1,c,sizeof(c)))>0){
  30:	8b 44 24 0c          	mov    0xc(%esp),%eax
  34:	c7 44 24 08 34 00 00 	movl   $0x34,0x8(%esp)
  3b:	00 
  3c:	89 74 24 04          	mov    %esi,0x4(%esp)
  40:	89 04 24             	mov    %eax,(%esp)
  43:	e8 82 02 00 00       	call   2ca <read>
  48:	85 c0                	test   %eax,%eax
  4a:	7e 28                	jle    74 <main+0x74>
  4c:	8d 3c 06             	lea    (%esi,%eax,1),%edi
  4f:	90                   	nop
       k=n;
       while(k>-1)
{
printf(1,"%c",c[k]);
  50:	0f be 17             	movsbl (%edi),%edx
  53:	83 ef 01             	sub    $0x1,%edi
  56:	c7 44 24 04 66 07 00 	movl   $0x766,0x4(%esp)
  5d:	00 
  5e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  65:	89 54 24 08          	mov    %edx,0x8(%esp)
  69:	e8 92 03 00 00       	call   400 <printf>
       while(k>-1)
  6e:	39 df                	cmp    %ebx,%edi
  70:	75 de                	jne    50 <main+0x50>
  72:	eb bc                	jmp    30 <main+0x30>
k--;
}
      }
      close(f1);
  74:	8b 44 24 0c          	mov    0xc(%esp),%eax
  78:	89 04 24             	mov    %eax,(%esp)
  7b:	e8 5a 02 00 00       	call   2da <close>
     
      exit();
  80:	e8 2d 02 00 00       	call   2b2 <exit>
  85:	66 90                	xchg   %ax,%ax
  87:	66 90                	xchg   %ax,%ax
  89:	66 90                	xchg   %ax,%ax
  8b:	66 90                	xchg   %ax,%ax
 ...
 40e:	8d 45 10             	lea    0x10(%ebp),%eax
{
 ...
 443:	88 55 e2             	mov    %dl,-0x1e(%ebp)
  write(fd, &c, 1);
 446:	e8 87 fe ff ff       	call   2d2 <write>
 ...
 4b6:	e8 17 fe ff ff       	call   2d2 <write>
        putc(fd, c);
 ...
 4d0:	88 55 e7             	mov    %dl,-0x19(%ebp)
  write(fd, &c, 1);
 4d3:	e8 fa fd ff ff       	call   2d2 <write>
  for(i = 0; fmt[i]; i++){
 ...
 52f:	8b 38                	mov    (%eax),%edi
          s = "(null)";
 531:	b8 69 07 00 00       	mov    $0x769,%eax
 ...
 5e0:	e8 ed fc ff ff       	call   2d2 <write>
        ap++;
...
free(void *ap)
{
 ...
 5f1:	a1 ec 09 00 00       	mov    0x9ec,%eax
{
 ...
 637:	89 10                	mov    %edx,(%eax)
  freep = p;
 639:	a3 ec 09 00 00       	mov    %eax,0x9ec
}
 63e:	5b                   	pop    %ebx
 63f:	5e                   	pop    %esi
 640:	5f                   	pop    %edi
 ...
 65f:	03 4b fc             	add    -0x4(%ebx),%ecx
  freep = p;
 662:	a3 ec 09 00 00       	mov    %eax,0x9ec
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 689:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 68c:	8b 1d ec 09 00 00    	mov    0x9ec,%ebx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6c9:	89 c2                	mov    %eax,%edx
    ...
    if(p == freep)
 6cb:	3b 15 ec 09 00 00    	cmp    0x9ec,%edx
 ...
 6ea:	e8 4b fc ff ff       	call   33a <sbrk>
  if(p == (char*)-1)
 ...
 6fd:	e8 ee fe ff ff       	call   5f0 <free>
  return freep;
 702:	8b 15 ec 09 00 00    	mov    0x9ec,%edx
 ...
 724:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 727:	89 15 ec 09 00 00    	mov    %edx,0x9ec
      return (void*)(p + 1);
 ...
 73c:	eb e9                	jmp    727 <malloc+0xa7>
    base.s.ptr = freep = prevp = &base;
 73e:	c7 05 ec 09 00 00 f0 	movl   $0x9f0,0x9ec
 745:	09 00 00 
    base.s.size = 0;
 748:	ba f0 09 00 00       	mov    $0x9f0,%edx
    base.s.ptr = freep = prevp = &base;
 74d:	c7 05 f0 09 00 00 f0 	movl   $0x9f0,0x9f0
 754:	09 00 00 
    base.s.size = 0;
 757:	c7 05 f4 09 00 00 00 	movl   $0x0,0x9f4
 75e:	00 00 00 
