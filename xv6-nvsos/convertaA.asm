...
_convertaA:     file format elf32-i386
...
char c[52];
   ...
   f:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
  16:	00 
  17:	8b 43 04             	mov    0x4(%ebx),%eax
  1a:	89 04 24             	mov    %eax,(%esp)
  1d:	e8 f0 02 00 00       	call   312 <open>
      int f2=open(argv[2], O_CREATE|O_RDWR);
  22:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
  29:	00 
      int f1=open(argv[1], O_CREATE|O_RDWR);
  2a:	89 c6                	mov    %eax,%esi
      int f2=open(argv[2], O_CREATE|O_RDWR);
  2c:	8b 43 08             	mov    0x8(%ebx),%eax
  2f:	8d 5c 24 1c          	lea    0x1c(%esp),%ebx
  33:	89 04 24             	mov    %eax,(%esp)
  36:	e8 d7 02 00 00       	call   312 <open>
  3b:	89 44 24 0c          	mov    %eax,0xc(%esp)
  3f:	90                   	nop
      while((n=read(f1,c,sizeof(c)))>0){
  40:	c7 44 24 08 34 00 00 	movl   $0x34,0x8(%esp)
  47:	00 
  48:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  4c:	89 34 24             	mov    %esi,(%esp)
  4f:	e8 96 02 00 00       	call   2ea <read>
  54:	85 c0                	test   %eax,%eax
  56:	89 c7                	mov    %eax,%edi
  58:	7e 3c                	jle    96 <main+0x96>
int i=0;
while( c[i] != '\0' ) 
  5a:	0f b6 54 24 1c       	movzbl 0x1c(%esp),%edx
  5f:	84 d2                	test   %dl,%dl
  61:	74 1d                	je     80 <main+0x80>
  63:	8d 4c 24 1d          	lea    0x1d(%esp),%ecx
  67:	90                   	nop
     {
        // if character is in lowercase
        // then subtract 32 
        if( c[i] >= 'a' && c[i] <= 'z' )
  68:	8d 42 9f             	lea    -0x61(%edx),%eax
  6b:	3c 19                	cmp    $0x19,%al
  6d:	77 06                	ja     75 <main+0x75>
        {
           c[i] = c[i] - 32;
  6f:	83 ea 20             	sub    $0x20,%edx
  72:	88 51 ff             	mov    %dl,-0x1(%ecx)
  75:	83 c1 01             	add    $0x1,%ecx
while( c[i] != '\0' ) 
  78:	0f b6 51 ff          	movzbl -0x1(%ecx),%edx
  7c:	84 d2                	test   %dl,%dl
  ...
  84:	89 7c 24 08          	mov    %edi,0x8(%esp)
  88:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  8c:	89 04 24             	mov    %eax,(%esp)
  8f:	e8 5e 02 00 00       	call   2f2 <write>
  94:	eb aa                	jmp    40 <main+0x40>
      }
      close(f1);
  96:	89 34 24             	mov    %esi,(%esp)
  99:	e8 5c 02 00 00       	call   2fa <close>
      close(f2);
  9e:	8b 44 24 0c          	mov    0xc(%esp),%eax
  a2:	89 04 24             	mov    %eax,(%esp)
  a5:	e8 50 02 00 00       	call   2fa <close>
      exit();
  aa:	e8 23 02 00 00       	call   2d2 <exit>
  af:	90                   	nop
...
free(void *ap)
{
 ...
 611:	a1 08 0a 00 00       	mov    0xa08,%eax
{
 ...
 657:	89 10                	mov    %edx,(%eax)
  freep = p;
 659:	a3 08 0a 00 00       	mov    %eax,0xa08
}
 65e:	5b                   	pop    %ebx
 65f:	5e                   	pop    %esi
 660:	5f                   	pop    %edi
 ...
 67f:	03 4b fc             	add    -0x4(%ebx),%ecx
  freep = p;
 682:	a3 08 0a 00 00       	mov    %eax,0xa08
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ac:	8b 1d 08 0a 00 00    	mov    0xa08,%ebx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6e9:	89 c2                	mov    %eax,%edx
    ...
    if(p == freep)
 6eb:	3b 15 08 0a 00 00    	cmp    0xa08,%edx
 ...
 71d:	e8 ee fe ff ff       	call   610 <free>
  return freep;
 722:	8b 15 08 0a 00 00    	mov    0xa08,%edx
 ...
 744:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 747:	89 15 08 0a 00 00    	mov    %edx,0xa08
      return (void*)(p + 1);
 ...
 75c:	eb e9                	jmp    747 <malloc+0xa7>
    base.s.ptr = freep = prevp = &base;
 75e:	c7 05 08 0a 00 00 0c 	movl   $0xa0c,0xa08
 765:	0a 00 00 
    base.s.size = 0;
 768:	ba 0c 0a 00 00       	mov    $0xa0c,%edx
    base.s.ptr = freep = prevp = &base;
 76d:	c7 05 0c 0a 00 00 0c 	movl   $0xa0c,0xa0c
 774:	0a 00 00 
    base.s.size = 0;
 777:	c7 05 10 0a 00 00 00 	movl   $0x0,0xa10
 77e:	00 00 00 
