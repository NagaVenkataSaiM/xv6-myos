...
printint(int fd, int xx, int base, int sgn)
{
 ...
 339:	0f b6 92 1c 07 00 00 	movzbl 0x71c(%edx),%edx
  }while((x /= base) != 0);
 ...
 3ae:	8d 45 10             	lea    0x10(%ebp),%eax
{
 ...
 4cf:	8b 38                	mov    (%eax),%edi
          s = "(null)";
 4d1:	b8 15 07 00 00       	mov    $0x715,%eax
...
free(void *ap)
{
 ...
 591:	a1 94 09 00 00       	mov    0x994,%eax
{
 ...
 5d7:	89 10                	mov    %edx,(%eax)
  freep = p;
 5d9:	a3 94 09 00 00       	mov    %eax,0x994
}
 5de:	5b                   	pop    %ebx
 5df:	5e                   	pop    %esi
 5e0:	5f                   	pop    %edi
 ...
 5ff:	03 4b fc             	add    -0x4(%ebx),%ecx
  freep = p;
 602:	a3 94 09 00 00       	mov    %eax,0x994
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 629:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 62c:	8b 1d 94 09 00 00    	mov    0x994,%ebx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 669:	89 c2                	mov    %eax,%edx
    ...
    if(p == freep)
 66b:	3b 15 94 09 00 00    	cmp    0x994,%edx
 ...
 69d:	e8 ee fe ff ff       	call   590 <free>
  return freep;
 6a2:	8b 15 94 09 00 00    	mov    0x994,%edx
 ...
 6c4:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 6c7:	89 15 94 09 00 00    	mov    %edx,0x994
      return (void*)(p + 1);
 ...
 6dc:	eb e9                	jmp    6c7 <malloc+0xa7>
    base.s.ptr = freep = prevp = &base;
 6de:	c7 05 94 09 00 00 98 	movl   $0x998,0x994
 6e5:	09 00 00 
    base.s.size = 0;
 6e8:	ba 98 09 00 00       	mov    $0x998,%edx
    base.s.ptr = freep = prevp = &base;
 6ed:	c7 05 98 09 00 00 98 	movl   $0x998,0x998
 6f4:	09 00 00 
    base.s.size = 0;
 6f7:	c7 05 9c 09 00 00 00 	movl   $0x0,0x99c
 6fe:	00 00 00 
