...
main(int argc, char *argv[])
{
  ...
  1d:	e8 c0 02 00 00       	call   2e2 <open>
  ...
  36:	e8 a7 02 00 00       	call   2e2 <open>
  3b:	89 c7                	mov    %eax,%edi
      while((n=read(f1,c,sizeof(c)))>0){
  3d:	eb 11                	jmp    50 <main+0x50>
  3f:	90                   	nop
      write(f2,c,n);
  40:	89 44 24 08          	mov    %eax,0x8(%esp)
  44:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  48:	89 3c 24             	mov    %edi,(%esp)
  4b:	e8 72 02 00 00       	call   2c2 <write>
      while((n=read(f1,c,sizeof(c)))>0){
  50:	c7 44 24 08 34 00 00 	movl   $0x34,0x8(%esp)
  57:	00 
  58:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  5c:	89 34 24             	mov    %esi,(%esp)
  5f:	e8 56 02 00 00       	call   2ba <read>
  64:	85 c0                	test   %eax,%eax
  66:	7f d8                	jg     40 <main+0x40>
      }
      close(f1);
  68:	89 34 24             	mov    %esi,(%esp)
  6b:	e8 5a 02 00 00       	call   2ca <close>
      close(f2);
  70:	89 3c 24             	mov    %edi,(%esp)
  73:	e8 52 02 00 00       	call   2ca <close>
      exit();
  78:	e8 25 02 00 00       	call   2a2 <exit>
  7d:	66 90                	xchg   %ax,%ax
  7f:	90                   	nop
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 389:	0f b6 92 5d 07 00 00 	movzbl 0x75d(%edx),%edx
  }while((x /= base) != 0);
 ...
 3fe:	8d 45 10             	lea    0x10(%ebp),%eax
{
 ...
 51f:	8b 38                	mov    (%eax),%edi
          s = "(null)";
 521:	b8 56 07 00 00       	mov    $0x756,%eax
...
free(void *ap)
{
 ...
 5e1:	a1 d8 09 00 00       	mov    0x9d8,%eax
{
 ...
 627:	89 10                	mov    %edx,(%eax)
  freep = p;
 629:	a3 d8 09 00 00       	mov    %eax,0x9d8
}
 62e:	5b                   	pop    %ebx
 62f:	5e                   	pop    %esi
 630:	5f                   	pop    %edi
 ...
 64f:	03 4b fc             	add    -0x4(%ebx),%ecx
  freep = p;
 652:	a3 d8 09 00 00       	mov    %eax,0x9d8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 679:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 67c:	8b 1d d8 09 00 00    	mov    0x9d8,%ebx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6b9:	89 c2                	mov    %eax,%edx
    ...
    if(p == freep)
 6bb:	3b 15 d8 09 00 00    	cmp    0x9d8,%edx
 ...
 6ed:	e8 ee fe ff ff       	call   5e0 <free>
  return freep;
 6f2:	8b 15 d8 09 00 00    	mov    0x9d8,%edx
 ...
 714:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 717:	89 15 d8 09 00 00    	mov    %edx,0x9d8
      return (void*)(p + 1);
 ...
 72c:	eb e9                	jmp    717 <malloc+0xa7>
    base.s.ptr = freep = prevp = &base;
 72e:	c7 05 d8 09 00 00 dc 	movl   $0x9dc,0x9d8
 735:	09 00 00 
    base.s.size = 0;
 738:	ba dc 09 00 00       	mov    $0x9dc,%edx
    base.s.ptr = freep = prevp = &base;
 73d:	c7 05 dc 09 00 00 dc 	movl   $0x9dc,0x9dc
 744:	09 00 00 
    base.s.size = 0;
 747:	c7 05 e0 09 00 00 00 	movl   $0x0,0x9e0
 74e:	00 00 00 
